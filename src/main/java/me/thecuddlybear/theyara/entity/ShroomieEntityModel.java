...
public class ShroomieEntityModel extends EntityModel<ShroomieEntity> {
    ...
    public ShroomieEntityModel(ModelPart modelPart){
    ...
    @Override
    public void setAngles(ShroomieEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
    }
